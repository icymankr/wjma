...
Begin
  ...
  fmN01Main := TfmN01Main.Create(AOwner);
  fmN01Main.ModuleID:= ModuleID;
  fmN01Main.BorderStyle:= bsNone;
  fmN01Main.Align:= alClient;
  fmN01Main.Parent:= Parent;
  If Visible = True then fmN01Main.Show;
End;
